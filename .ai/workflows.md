...
- Keep finished-work context concise in `_project_specs/session/current-state.md`; add durable rationale to `decisions.md` and new navigation anchors to `code-landmarks.md` when needed.
