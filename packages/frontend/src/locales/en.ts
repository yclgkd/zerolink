const en = {
  ...
  share: {
    ...
    fileLabel: 'Decrypted file',
    fileNameLabel: 'Name',
    fileSizeLabel: 'Size',
    fileTypeLabel: 'Type',
    fileDownloadButton: 'Download file',
    fileDownloadHint: 'ZeroLink does not preview files. Download happens only after you click.',
    cipherVersionNotice:
      'The content has been updated. You are about to decrypt the latest version.',
    burnedTitle: 'Local decrypted copy removed from this device.',
    burnedBody:
      'This does not delete the channel or mark it expired. Re-enter your passphrase to decrypt again.',
    burnedToast: 'Local decrypted copy removed.',
