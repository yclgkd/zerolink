...
describe('AES-256-GCM', () => {
  ...
  // boundary = padBlock - PAD_LENGTH_PREFIX_BYTES = 8192 - 4 = 8188
  it('maps all plaintexts in the same padBlock=8192 bucket to the same ciphertext length', async () => {
    ...
    const boundary = padBlock - 4; // 8188
