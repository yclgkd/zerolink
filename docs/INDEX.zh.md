...
- **技术栈** → [TECH_STACK.md](./TECH_STACK.zh.md)
...
#### API 协议
- **完整 API 定义** → [PRD.md § 10. API](./PRD.zh.md#10-api-v30-当前)
...
#### 测试
- **测试向量** → [PRD.md § 14. 测试向量与验收](./PRD.zh.md#14-测试向量与验收v30)
- **跨运行时自部署 fixture** → [SELF_HOSTED_CONTRACT.zh.md § Fixture 使用规则](./SELF_HOSTED_CONTRACT.zh.md#fixture-使用规则)
- **安全不变量** → [SECURITY.md § 安全不变量](./SECURITY.zh.md#安全不变量implementation)
...
2. [TECH_STACK.md](./TECH_STACK.zh.md) - 技术栈概览
...
### 后端开发
1. [QUICK_START.md](./QUICK_START.zh.md) - 初始化项目
2. [ARCHITECTURE.md](./ARCHITECTURE.zh.md) - 系统架构
3. [SELF_HOSTED_CONTRACT.zh.md](./SELF_HOSTED_CONTRACT.zh.md) - 自部署后端契约
4. [PRD.md § 10](./PRD.zh.md#10-api-v30-当前) - 完整 API
...
3. [SECURITY.md § 安全不变量](./SECURITY.zh.md#安全不变量implementation) - 审计要点
4. [SECURITY.md § 密码学规范](./SECURITY.zh.md#密码学规范) - 加密参数
5. [PRD.md § 14](./PRD.zh.md#14-测试向量与验收v30) - 测试向量

### DevOps / 部署
1. [DEPLOYMENT.md](./DEPLOYMENT.zh.md) - 完整部署指南
2. [SELF_HOSTED_DEPLOYMENT.md](./SELF_HOSTED_DEPLOYMENT.zh.md) - Docker Compose 自部署
3. [VERIFY.md](./VERIFY.zh.md) - 构建完整性验证
...
### Q: WebAuthn 私钥能被导出吗？
→ [SECURITY.md § 管理权私钥不可导出](./SECURITY.zh.md#7-管理权私钥不可导出-secure-share)
